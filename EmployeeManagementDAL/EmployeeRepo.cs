...
namespace EmployeeManagementDAL
{
    ...
    {
        static readonly string connect = "Data Source=desktop-qp0qma4\\sqlexpress;Initial Catalog=EmployeeDB;Integrated Security=True";
        ...
        public int DeleteEmployee(int empId)
        {
            try
            {
                using (this.connection)
                {
                    SqlCommand command = new SqlCommand("spD", this.connection);
                    command.CommandType = CommandType.StoredProcedure;
        ...
        public DisplayEmployeeDetails UpdateEmployee(DisplayEmployeeDetails details)
        {
            try
            {
                using (this.connection)
                {
                    ...
                    {
                        SqlCommand employeeUpdate = new SqlCommand("spU", this.connection,transaction);
